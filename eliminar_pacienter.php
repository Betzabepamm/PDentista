...
// Verificar si el usuario es recepcionista (o quien tenga permiso para eliminar pacientes)
...
// Obtener el ID de la recepcionista logueada
$id_recepcionista = $_SESSION['id_personal'];  // Asegúrate de que 'id_personal' esté en la sesión
